 ...
 */
function uuam_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'uuam_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.uuam-front-page) .entry-title,
...
.colors-custom .uuam-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.uuam-front-page .panel-content .recent-posts article,
...
.colors-custom.uuam-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'uuam_custom_colors_css', $css, $hue, $saturation );
}
